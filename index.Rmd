...
### Highest percentage of cases per state 
```{r, echo=F}
...
### Highest percentage of deaths per state
```{r, echo=F}
...
Next to look at the data a little closer to home, for Oregon Counties. Initially filtering by the most recent date, which as of this being written is **September 16th, 2021**, and then look at the top five Oregon counties.
...
### Highest percentage of cases per county 
```{r, echo = F}
#cases percent
...
### Highest percentage of deaths per county
```{r, echo = F}
#deaths percentage
