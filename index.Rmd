...
Next to look at the data a little closer to home, for Oregon Counties. Initially filtering by the most recent date, which as of this being written is **September 1st, 2021**, and then look at the top five Oregon counties with :
...
or.county.cases <- or.covid.est %>%
  ...
  arrange(desc(cases)) %>%
    ...
    tab_header(title = md("**Most Cases**"),
               subtitle = "Oregon Counties as of September 1st, 2021") %>%
