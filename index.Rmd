...
To begin lets look at the country as a whole, by state. The data will be filtered for **December 21st, 2021**, and then lets look at the top five states with :
...
us.states.cases <- us.states.vacc %>%
  ...
  arrange(desc(cases)) %>%
    ...
    tab_header(title = md("**Most Cases**"),
               subtitle = "By State as of December 21st, 2021") %>%
...
or.county.cases <- or.covid.est %>%
  ...
  arrange(desc(cases)) %>%
    ...
    tab_header(title = md("**Most Cases**"),
               subtitle = "Oregon Counties as of December 21st, 2021") %>%
