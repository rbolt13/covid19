...
To begin lets look at the country as a whole, by state. The data will be filtered for **September 16th, 2021**, and then lets look at the top five states with :
...
#     tab_header(title = md("**Most Cases**"),
#                subtitle = "Oregon Counties as of September 16th, 2021") %>%
...
us.states.deaths <- us.states.vacc %>%
  ...
  arrange(desc(deaths)) %>%
    ...
    tab_header(title = md("**Most Deaths**"),
               subtitle = " as of September 16th, 2021") %>%
    cols_label(state = md("**State**"),
               population = md("**Total Population**"),
               deaths = md("**Deaths**"),
...
us.states.deaths.perc <- us.states.vacc %>%
  ...
  arrange(desc(perc.deaths)) %>%
    ...
    tab_header(title = md("**Highest percent of Deaths**"),
               subtitle = "By state, as of September 16th, 2021") %>%
    cols_label(state = md("**State**"),
               population = md("**Total Population**"),
               deaths = md("**Deaths**"),
               perc.deaths = md("**Percentage**"))
...
Next to look at the data a little closer to home, for Oregon Counties. Initially filtering by the most recent date, which as of this being written is **September 16th, 2021**, and then look at the top five Oregon counties with :
